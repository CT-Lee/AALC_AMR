...
struct GeneralSystemStateMsg_
{
  ...
  _manipulation_status_type manipulation_status;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _safe_cut_off_path_type;
  _safe_cut_off_path_type safe_cut_off_path;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _non_safe_cut_off_path_type;
  _non_safe_cut_off_path_type non_safe_cut_off_path;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _reset_required_cut_off_path_type;
