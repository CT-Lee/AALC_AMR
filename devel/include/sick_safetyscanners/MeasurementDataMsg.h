...
struct MeasurementDataMsg_
{
  ...
  _number_of_beams_type number_of_beams;
   ...
   typedef std::vector< ::sick_safetyscanners::ScanPointMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sick_safetyscanners::ScanPointMsg_<ContainerAllocator> >> _scan_points_type;
