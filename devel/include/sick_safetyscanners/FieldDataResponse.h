...
struct FieldDataResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::sick_safetyscanners::FieldMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sick_safetyscanners::FieldMsg_<ContainerAllocator> >> _fields_type;
  _fields_type fields;
  ...
  _device_name_type device_name;
   ...
   typedef std::vector< ::sick_safetyscanners::MonitoringCaseMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sick_safetyscanners::MonitoringCaseMsg_<ContainerAllocator> >> _monitoring_cases_type;
