...
struct ApplicationOutputsMsg_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _evaluation_path_outputs_eval_out_type;
  _evaluation_path_outputs_eval_out_type evaluation_path_outputs_eval_out;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _evaluation_path_outputs_is_safe_type;
  _evaluation_path_outputs_is_safe_type evaluation_path_outputs_is_safe;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _evaluation_path_outputs_is_valid_type;
  _evaluation_path_outputs_is_valid_type evaluation_path_outputs_is_valid;

   typedef std::vector<uint16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint16_t>> _monitoring_case_number_outputs_type;
  _monitoring_case_number_outputs_type monitoring_case_number_outputs;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _monitoring_case_number_outputs_flags_type;
  ...
  _linear_velocity_outputs_velocity_1_transmitted_safely_type linear_velocity_outputs_velocity_1_transmitted_safely;
   ...
   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _resulting_velocity_type;
  _resulting_velocity_type resulting_velocity;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _resulting_velocity_flags_type;
