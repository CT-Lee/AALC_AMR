...
if(NOT "/home/ctlee/catkin_ws/src/state_machine/include " STREQUAL " ")
  set(state_machine_INCLUDE_DIRS "")
  set(_include_dirs "/home/ctlee/catkin_ws/src/state_machine/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ctlee/catkin_ws/src/state_machine/${idir}'.  ${_report}")
    endif()
