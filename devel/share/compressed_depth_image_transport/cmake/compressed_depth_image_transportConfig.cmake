...
if("TRUE" STREQUAL "TRUE")
  set(compressed_depth_image_transport_SOURCE_PREFIX /home/cas-standIPC/AALC_AMR/src/image_transport_plugins/compressed_depth_image_transport)
  set(compressed_depth_image_transport_DEVEL_PREFIX /home/cas-standIPC/AALC_AMR/devel)
  ...
  set(compressed_depth_image_transport_INSTALL_PREFIX /home/cas-standIPC/AALC_AMR/install)
...
if(NOT "/home/cas-standIPC/AALC_AMR/devel/include;/home/cas-standIPC/AALC_AMR/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/include/opencv4 " STREQUAL " ")
  set(compressed_depth_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/home/cas-standIPC/AALC_AMR/devel/include;/home/cas-standIPC/AALC_AMR/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_depth_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cas-standIPC/AALC_AMR/src/image_transport_plugins/compressed_depth_image_transport/${idir}'.  ${_report}")
    endif()
